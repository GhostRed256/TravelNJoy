...
function CarsContent() {
  ...
  useEffect(() => {
    ...
    fetch('/api/cars?filter=public', { signal: controller.signal, cache: 'no-store' })
      .then((res) => {
          ...
          <div className="flex-1">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <button type="button" onClick={clearFilters} className="btn-primary">Clear All Filters</button>
              </div>
            ) : (
              <motion.div 
